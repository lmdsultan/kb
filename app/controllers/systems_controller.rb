class SystemsController < ApplicationController
  ...
  # GET /systems.json
  def index
    @systems = current_admin.systems.all
  end
  ...
  # GET /systems/new
  def new
    @system = current_admin.systems.new
  end
  ...
  # POST /systems.json
  def create
    @system = current_admin.systems.new(system_params)
  ...
  private
    ...
    def set_system
      @system = current_admin.systems.find(params[:id])
    end
