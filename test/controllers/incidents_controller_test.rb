...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post incidents_url, params: { incident: { issue: @incident.issue, solution: @incident.solution, system_id: @incident.system_id } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { issue: @incident.issue, solution: @incident.solution, system_id: @incident.system_id } }
