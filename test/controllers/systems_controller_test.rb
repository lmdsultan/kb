...
class SystemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create system" do
    assert_difference('System.count') do
      post systems_url, params: { system: { admin_id: @system.admin_id, name: @system.name } }
    end
  ...
  test "should update system" do
    patch system_url(@system), params: { system: { admin_id: @system.admin_id, name: @system.name } }
